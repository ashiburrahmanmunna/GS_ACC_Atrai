...
namespace Invoice.Data.Reports
{
    public class ProductReport
    {
        ...
        public List<ProductModel> _model;
        ...
        #endregion
        public byte[] CreateReport(List<ProductModel> model)
        {
            _model = model;
        ...
        private void reportHeader(ProductModel model)
        {
            _fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
            _pdfPCell = new PdfPCell(new Phrase("PRODUCT NAME  : " + model.Name, _fontStyle));
            ...
            _pdfPCell = new PdfPCell(new Phrase("Barcode : " + model.Code, _fontStyle));
            _pdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _pdfPCell.Border = 0;
            _pdfPCell.BackgroundColor = BaseColor.WHITE;
            _pdfPCell.ExtraParagraphSpace = 0;
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 9f, 0);
            _pdfPCell = new PdfPCell(new Phrase("Cost Price : " + model.CostPrice, _fontStyle));
            _pdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _pdfPCell.Border = 0;
            _pdfPCell.BackgroundColor = BaseColor.WHITE;
            _pdfPCell.ExtraParagraphSpace = 0;
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 9f, 0);
            _pdfPCell = new PdfPCell(new Phrase("Sales Price : " + model.Price, _fontStyle));
            _pdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _pdfPCell.Border = 0;
            _pdfPCell.BackgroundColor = BaseColor.WHITE;
            _pdfPCell.ExtraParagraphSpace = 0;
        ...
        //    _pdfPCell = new PdfPCell(new Phrase("Sales Invoice generated by : Dominatebd, contact : facebook.com/Dominatebd ", _fontStyle));
        //    _pdfPCell.Colspan = _totalColumn;
        //    _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
        //    _pdfPCell.Border = 0;
        //    _pdfPCell.BackgroundColor = BaseColor.WHITE;
