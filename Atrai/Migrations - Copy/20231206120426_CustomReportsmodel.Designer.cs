...
namespace Atrai.Migrations
{
    ...
    [Migration("20231206120426_CustomReportsmodel")]
    partial class CustomReportsmodel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Atrai.Core.Entity.CustomFormStyleModel", b =>
                {
                    ...
                    b.Property<int?>("LogoPlacementId")
                        .HasColumnType("int");

                    b.Property<int?>("LogoPlacementsId")
                        .HasColumnType("int");

                    b.Property<int?>("LogoSizeId")
                        .HasColumnType("int");

                    b.Property<int?>("LogoSizesId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("PageMarginBottomId")
                        .HasColumnType("int");

                    b.Property<int?>("PageMarginBottomsId")
                        .HasColumnType("int");

                    b.Property<int?>("PageMarginLeftId")
                        .HasColumnType("int");

                    b.Property<int?>("PageMarginLeftsId")
                        .HasColumnType("int");

                    b.Property<int?>("PageMarginRightId")
                        .HasColumnType("int");

                    b.Property<int?>("PageMarginRightsId")
                        .HasColumnType("int");

                    b.Property<int?>("PageMarginTopId")
                        .HasColumnType("int");

                    b.Property<int?>("PageMarginTopsId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FontFamiliesId");

                    b.HasIndex("FontSizesId");

                    b.HasIndex("LogoPlacementsId");

                    b.HasIndex("LogoSizesId");

                    b.HasIndex("LuserId");

                    b.HasIndex("PageMarginBottomsId");

                    b.HasIndex("PageMarginLeftsId");

                    b.HasIndex("PageMarginRightsId");

                    b.HasIndex("PageMarginTopsId");

                    b.HasIndex("TemplatesId");

                    b.ToTable("Custom Form Style");
                });
            ...
            modelBuilder.Entity("Atrai.Core.Entity.CustomReportModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Atrai.Core.Entity.CustomFormStyleModel", b =>
                {
                    b.HasOne("Atrai.Core.Entity.CustomFormStyleVariableModel", "Colors")
                        .WithMany()
                    ...
                    b.HasOne("Atrai.Core.Entity.CustomFormStyleVariableModel", "FontFamilies")
                        .WithMany()
                        .HasForeignKey("FontFamiliesId");

                    b.HasOne("Atrai.Core.Entity.CustomFormStyleVariableModel", "FontSizes")
                        .WithMany()
                        .HasForeignKey("FontSizesId");

                    b.HasOne("Atrai.Core.Entity.CustomFormStyleVariableModel", "LogoPlacements")
                        .WithMany()
                        .HasForeignKey("LogoPlacementsId");

                    b.HasOne("Atrai.Core.Entity.CustomFormStyleVariableModel", "LogoSizes")
                        .WithMany()
                        .HasForeignKey("LogoSizesId");
                    ...
                    b.HasOne("Atrai.Core.Entity.CustomFormStyleVariableModel", "PageMarginBottoms")
                        .WithMany()
                        .HasForeignKey("PageMarginBottomsId");

                    b.HasOne("Atrai.Core.Entity.CustomFormStyleVariableModel", "PageMarginLefts")
                        .WithMany()
                        .HasForeignKey("PageMarginLeftsId");

                    b.HasOne("Atrai.Core.Entity.CustomFormStyleVariableModel", "PageMarginRights")
                        .WithMany()
                        .HasForeignKey("PageMarginRightsId");

                    b.HasOne("Atrai.Core.Entity.CustomFormStyleVariableModel", "PageMarginTops")
                        .WithMany()
                        .HasForeignKey("PageMarginTopsId");

                    b.HasOne("Atrai.Core.Entity.CustomFormStyleVariableModel", "Templates")
                        .WithMany()
                    ...
                    b.Navigation("FontSizes");

                    b.Navigation("LogoPlacements");

                    b.Navigation("LogoSizes");

                    b.Navigation("PageMarginBottoms");

                    b.Navigation("PageMarginLefts");

                    b.Navigation("PageMarginRights");

                    b.Navigation("PageMarginTops");
            ...
            modelBuilder.Entity("Atrai.Core.Entity.EmployeeModel", b =>
                {
                    ...
                    b.HasOne("Atrai.Core.Entity.Cat_Emp_TypeModel", "Cat_Emp_Type")
                        .WithMany()
