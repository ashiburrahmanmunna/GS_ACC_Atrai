...
namespace Atrai.Migrations
{
    ...
    [Migration("20231204122318_PurchaseTagTableCreateUpdated")]
    partial class PurchaseTagTableCreateUpdated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Atrai.Core.Entity.ReportStyleMainModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("FontFamilyVariableId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FontFamilyVariableId");
                    ...
                    b.ToTable("ReportStyleMainModel");
                });
            ...
            modelBuilder.Entity("Atrai.Core.Entity.ReportStyleVariableModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReportStyleVariableModel");
                });
            ...
            modelBuilder.Entity("Atrai.Core.Entity.ReportStyleMainModel", b =>
                {
                    b.HasOne("Atrai.Core.Entity.ReportStyleVariableModel", "ColorVariable")
                        .WithMany()
                        .HasForeignKey("ColorId");

                    b.HasOne("Atrai.Core.Entity.ReportStyleVariableModel", "FontFamilyVariable")
                        .WithMany()
                        .HasForeignKey("FontFamilyVariableId");

                    b.HasOne("Atrai.Core.Entity.ReportStyleVariableModel", "FontSizeVariable")
                        .WithMany()
                        .HasForeignKey("FontSizeId");

                    b.HasOne("Atrai.Core.Entity.ReportStyleVariableModel", "LogoPlacementVariable")
                        .WithMany()
                        .HasForeignKey("LogoPlacementId");

                    b.HasOne("Atrai.Core.Entity.ReportStyleVariableModel", "LogoSizeVariable")
                        .WithMany()
                        .HasForeignKey("LogoSizeId");

                    b.HasOne("Atrai.Core.Entity.ReportStyleVariableModel", "TemplateVariable")
                        .WithMany()
                        .HasForeignKey("TemplateId");

                    b.Navigation("ColorVariable");

                    b.Navigation("FontFamilyVariable");

                    b.Navigation("FontSizeVariable");

                    b.Navigation("LogoPlacementVariable");

                    b.Navigation("LogoSizeVariable");
