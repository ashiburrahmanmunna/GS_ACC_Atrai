...
namespace Invoice.Migrations
{
    ...
    [Migration("20220729042550_tablenamechangeswithmodelname")]
    partial class tablenamechangeswithmodelname
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Invoice.Core.Entity.Cat_Bank", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Invoice.Core.Entity.Cat_BankBranch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Invoice.Core.Entity.Cat_BuildingType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Invoice.Core.Entity.Cat_Emp_Type", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Invoice.Core.Entity.Cat_Gender", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Invoice.Core.Entity.Cat_Leave_Type", b =>
                {
                    b.Property<int>("LTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("LTypeId"), 1L, 1);
            ...
            modelBuilder.Entity("Invoice.Core.Entity.Cat_PostOffice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Invoice.Core.Entity.Cat_Skill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Invoice.Core.Entity.HR_Emp_Education", b =>
                {
                    b.Property<int>("EmpEduId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EmpEduId"), 1L, 1);
            ...
            modelBuilder.Entity("Invoice.Core.Entity.HR_Emp_Experience", b =>
                {
                    b.Property<int>("EmpExpId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EmpExpId"), 1L, 1);
            ...
            modelBuilder.Entity("Invoice.Core.Entity.HR_Emp_Family", b =>
                {
                    b.Property<int>("EmpFamilyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EmpFamilyId"), 1L, 1);
            ...
            modelBuilder.Entity("Invoice.Core.Entity.HR_Emp_Nominee", b =>
                {
                    b.Property<int>("EmpNomId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EmpNomId"), 1L, 1);
            ...
            modelBuilder.Entity("Invoice.Core.Entity.HR_Emp_PersonalInfo", b =>
                {
                    b.Property<int>("EmpPersInfoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EmpPersInfoId"), 1L, 1);
            ...
            modelBuilder.Entity("Invoice.Core.Entity.EmployeeModel", b =>
                {
                    ...
                    b.HasOne("Invoice.Core.Entity.Cat_Emp_Type", "Cat_Emp_Type")
                        .WithMany()
                    ...
                    b.HasOne("Invoice.Core.Entity.Cat_Gender", "Cat_Gender")
                        .WithMany()
                    ...
                    b.HasOne("Invoice.Core.Entity.Cat_Skill", "Cat_Skill")
                        .WithMany()
            ...
            modelBuilder.Entity("Invoice.Core.Entity.HR_Emp_Address", b =>
                {
                    ...
                    b.HasOne("Invoice.Core.Entity.Cat_PostOffice", "Cat_PostOfficeCurr")
                        .WithMany()
                    ...
                    b.HasOne("Invoice.Core.Entity.Cat_PostOffice", "Cat_PostOfficePer")
                        .WithMany()
            ...
            modelBuilder.Entity("Invoice.Core.Entity.HR_Emp_BankInfo", b =>
                {
                    ...
                    b.HasOne("Invoice.Core.Entity.Cat_Bank", "Cat_Bank")
                        .WithMany()
                        .HasForeignKey("BankId");

                    b.HasOne("Invoice.Core.Entity.Cat_BankBranch", "Cat_BankBranch")
                        .WithMany()
            ...
            modelBuilder.Entity("Invoice.Core.Entity.HR_Emp_Family", b =>
                {
                    b.HasOne("Invoice.Core.Entity.EmployeeModel", "HR_Emp_Info")
                        ...
                        .HasForeignKey("Invoice.Core.Entity.HR_Emp_Family", "EmpId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Invoice.Core.Entity.HR_Emp_Increment", b =>
                {
                    ...
                    b.HasOne("Invoice.Core.Entity.Cat_Emp_Type", "Cat_Emp_TypeNew")
                        .WithMany()
                        .HasForeignKey("NewEmpTypeId");

                    b.HasOne("Invoice.Core.Entity.Cat_Gender", "Cat_GenderNew")
                        .WithMany()
                    ...
                    b.HasOne("Invoice.Core.Entity.Cat_Emp_Type", "Cat_Emp_TypeOld")
                        .WithMany()
                        .HasForeignKey("OldEmpTypeId");

                    b.HasOne("Invoice.Core.Entity.Cat_Gender", "Cat_GenderOld")
                        .WithMany()
            ...
            modelBuilder.Entity("Invoice.Core.Entity.HR_Emp_Nominee", b =>
                {
                    b.HasOne("Invoice.Core.Entity.EmployeeModel", "HR_Emp_Info")
                        ...
                        .HasForeignKey("Invoice.Core.Entity.HR_Emp_Nominee", "EmpId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Invoice.Core.Entity.HR_Emp_PersonalInfo", b =>
                {
                    b.HasOne("Invoice.Core.Entity.Cat_BuildingType", "Cat_BuildingType")
                        .WithMany()
                        .HasForeignKey("BId");

                    b.HasOne("Invoice.Core.Entity.EmployeeModel", "HR_Emp_Info")
                        .WithOne("HR_Emp_PersonalInfo")
                        .HasForeignKey("Invoice.Core.Entity.HR_Emp_PersonalInfo", "EmpId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Invoice.Core.Entity.HR_Emp_Salary", b =>
                {
                    b.HasOne("Invoice.Core.Entity.Cat_BuildingType", "Cat_BuildingTypeHC")
                        .WithMany()
                        .HasForeignKey("BId");
            ...
            modelBuilder.Entity("Invoice.Core.Entity.HR_Leave_Avail", b =>
                {
                    ...
                    b.HasOne("Invoice.Core.Entity.Cat_Leave_Type", "Cat_Leave_Type")
                        .WithMany()
