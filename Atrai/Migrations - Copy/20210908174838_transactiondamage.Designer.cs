...
namespace Invoice.Migrations
{
    ...
    [Migration("20210908174838_transactiondamage")]
    partial class transactiondamage
    {
            ...
            modelBuilder.Entity("Invoice.Core.Entity.CostCalculatedModel", b =>
                {
                    ...
                    b.HasOne("Invoice.Core.Entity.DamageModel", null)
                        .WithMany("CostCalculations")
                        .HasForeignKey("DamageModelId");
