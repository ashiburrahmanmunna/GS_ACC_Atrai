...
namespace Invoice.Migrations
{
    ...
    [Migration("20210727075545_internetpackage")]
    partial class internetpackage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Invoice.Core.Entity.InternetMemberModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("InternetMember");
                });

            modelBuilder.Entity("Invoice.Core.Entity.InternetMemberStatusModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("InternetMemberStatus");
                });
            ...
            modelBuilder.Entity("Invoice.Core.Entity.InternetPackageModel", b =>
                {
                    ...
                    b.Property<string>("PackageActiveDay")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("Invoice.Core.Entity.InternetMemberModel", b =>
                {
                    b.HasOne("Invoice.Core.Entity.InternetMemberStatusModel", "MemberStatus")
                        .WithMany()
