...
namespace Invoice.Migrations
{
    ...
    [Migration("20210619105307_customersuppliermemberinTransactionTable")]
    partial class customersuppliermemberinTransactionTable
    {
            ...
            modelBuilder.Entity("Invoice.Core.Entity.MemberModel", b =>
                {
                    ...
                    b.Property<string>("MemberFileExtension")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Invoice.Core.Entity.TransactionModel", b =>
                {
                    ...
                    b.HasOne("Invoice.Core.Entity.CustomerModel", "vCustomer")
                        .WithMany()
                        .HasForeignKey("CustomerId");

                    b.HasOne("Invoice.Core.Entity.MemberModel", "vMember")
                        .WithMany()
                    ...
                    b.HasOne("Invoice.Core.Entity.SupplierModel", "vSupplier")
                        .WithMany()
