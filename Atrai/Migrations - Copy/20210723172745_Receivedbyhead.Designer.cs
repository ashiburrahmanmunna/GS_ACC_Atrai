...
namespace Invoice.Migrations
{
    ...
    [Migration("20210723172745_Receivedbyhead")]
    partial class Receivedbyhead
    {
            ...
            modelBuilder.Entity("Invoice.Core.Entity.InvoiceBillModel", b =>
                {
                    ...
                    b.Property<int?>("AccountReceiveByHeadId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AccountReceiveByHeadId");
            ...
            modelBuilder.Entity("Invoice.Core.Entity.InvoiceBillModel", b =>
                {
                    b.HasOne("Invoice.Core.Entity.AccountHeadModel", "AccountReceiveByHead")
                        .WithMany()
                        .HasForeignKey("AccountReceiveByHeadId");
