...
namespace Invoice.Migrations
{
    ...
    [Migration("20210926073745_salesreturnrefsaleid")]
    partial class salesreturnrefsaleid
    {
            ...
            modelBuilder.Entity("Invoice.Core.Entity.TransactionModel", b =>
                {
                    ...
                    b.Property<int?>("PurchaseReturnModelId")
                        .HasColumnType("int");

                    b.Property<int?>("SalesId")
                        .HasColumnType("int");

                    b.Property<int?>("SalesReturnModelId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PurchaseReturnModelId");

                    b.HasIndex("SalesId");

                    b.HasIndex("SalesReturnModelId");
            ...
            modelBuilder.Entity("Invoice.Core.Entity.TransactionModel", b =>
                {
                    ...
                    b.HasOne("Invoice.Core.Entity.PurchaseReturnModel", null)
                        .WithMany("AccountTransaction")
                        .HasForeignKey("PurchaseReturnModelId");

                    b.HasOne("Invoice.Core.Entity.SalesModel", "Sales")
                        .WithMany("AccountTransaction")
                        .HasForeignKey("SalesId");

                    b.HasOne("Invoice.Core.Entity.SalesReturnModel", null)
                        .WithMany("AccountTransaction")
                        .HasForeignKey("SalesReturnModelId");
